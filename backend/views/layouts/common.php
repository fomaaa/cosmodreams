    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 <?php echo $keyStorage->get('adminlte.sidebar-no-expand') ? 'sidebar-no-expand' : null ?>">
        ...
        <a href="/" class="brand-link text-center <?php echo $keyStorage->get('adminlte.brand-text-small') ? 'text-sm' : null ?>">
            <!-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8"> -->
            <span class="brand-text font-weight-bold">Comsodreams</span>
        </a>
        <!-- /brand logo -->
...
//                        ],
                        [
                            ...
                            'url' => ['/script-3d/index'],
                            'icon' => FAS::icon('thumbtack', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'script-3d',
                        ],
                        [
                            'label' => 'Маски',
                            'url' => ['/masks/index'],
                            'icon' => FAS::icon('thumbtack', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'masks',
                        ],
                        [
                            'label' => 'Галерея №1',
                            'url' => ['/gallery/index'],
                        ...
                        [
                            ...
                            'url' => ['/gallery2/index'],
                            'icon' => FAS::icon('thumbtack', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'gallery2',
                        ],
                        [
                            'label' => 'Авторы',
                            'url' => ['/author/index'],
